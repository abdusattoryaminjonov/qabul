...
class FormQuestion extends Model
{
    ...
    public function questionTranslations(): array
    {
    ...
    {
        return FormTranslations::resolve($this->questionTranslations(), 'title', $this->title, $locale);
    }

    public function localizedDescription(?string $locale = null): string
    {
        return FormTranslations::resolve($this->questionTranslations(), 'description', $this->description ?? '', $locale);
    }

    public function localizedScaleLabel(string $key, ?string $locale = null): string
    {
        $fallback = $this->settings[$key] ?? '';

        return FormTranslations::resolve($this->questionTranslations(), $key, $fallback, $locale);
    }
}
